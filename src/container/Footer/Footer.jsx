            ...
            <div className="row align-items-center">
                <div className="col-lg-6 col-md-6 col-12">
                    <div className="footer__links text-center">
                        ...
                        <a href="https://www.linkedin.com/in/samuel-adewale-2060a71b6"target="_blank" rel="noreferrer"><i className="fa-brands fa-linkedin-in"></i></a>
                    </div>
                </div>
                <div className="col-lg-6 col-md-6 col-12 text-center">
                    <p className="footer__copy">Copyright &copy; {year} Sammy</p>
                </div>
            </div>
        </div>
    </footer>
