                            ...
                            <>
                              {item.liveDeploy && (
                                <div className="project__item-links-item live">
                                  <a href="https://andern-1797.myshopify.com/" target="_blank" rel="noreferrer">Live Deployment <i className="fas fa-external-link-alt"></i></a>
                                </div>
                              )}

                              {item.sourceCode && (
                                <div className="project__item-links-item code">
                                  <a href="https://www.parlourx.com/" target="_blank" rel="noreferrer">Source Code <i className="fa-brands fa-github"></i></a>
                                </div>
                              )}
                            </>
                          ) : (
